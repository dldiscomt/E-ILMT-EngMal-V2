...
# E-ILMT - English to Malayalam MT - V2
...
Download the model from the provided drive link: 
   ...
   [https://drive.google.com/drive/folders/1c0fm1TGE5LrruysGyPOv5Wp6d279Kn_4?usp=sharing](https://drive.google.com/drive/folders/1c0fm1TGE5LrruysGyPOv5Wp6d279Kn_4?usp=sharing)
...
gdown --folder https://drive.google.com/drive/folders/1c0fm1TGE5LrruysGyPOv5Wp6d279Kn_4?usp=sharing
...
## windows
   ...
   docker build -t <Image Name> <basepath/Eng-Mal-NMT-V2-AUKBC-ULCA-Deploy/>
```
Or on Ubuntu:
```bash
## ubuntu

   sudo docker build -t <Image Name> <basepath/Eng-Mal-NMT-V2-AUKBC-ULCA-Deploy/>
```
...
<br>
![App Screenshot](https://github.com/dldiscomt/E-ILMT-EngMal-V2/blob/main/OutputScreenshots/Picture1.jpg?raw=true)
...
<br>
![App Screenshot ](https://github.com/dldiscomt/E-ILMT-EngMal-V2/blob/main/OutputScreenshots/Picture2.jpg?raw=true)


input :"A cash prize has also been announced."
<br>
![App Screenshot](https://github.com/dldiscomt/E-ILMT-EngMal-V2/blob/main/OutputScreenshots/Picture3.jpg?raw=true)
